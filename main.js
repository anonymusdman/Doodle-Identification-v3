...
random_number = Math.floor((Math.random()*quick_draw_data_set.length)+0);
...
function updateCanvas(){
    canvas.background("rgb(255, 255, 0)");
    canvas.center();
}
...
function check_sketch(){
    ...
    document.getElementById("timer").innerHTML = "Time: " + timer_counter + " milliseconds";
